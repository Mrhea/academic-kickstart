...
# Role/position
role: Software Developer and Research Assistant
...
bio: My research interests include programming languages and distributed systems.
...
- icon: envelope
  icon_pack: fas
  link: 'mailto:mrhea@ucsc.edu'
  # link: '#contact'  # For a direct email link, use "mailto:test@example.org".
- icon: twitter
  icon_pack: fab
  link: https://twitter.com/MatthewRhea
# - icon: google-scholar
#   icon_pack: ai
